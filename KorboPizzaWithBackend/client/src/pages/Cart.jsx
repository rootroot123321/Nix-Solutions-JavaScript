...
import {removeCartItem, clearCart, plusCartItem, minusCartItem} from "../redux/actions/cart";
...
function Cart() {
    ...
    const onClearCart = () => {
        if (window.confirm('Are you sure that you want to clear the cart?'))
            dispatch(clearCart())
    };
    const onClickOrder = () => {
                    ...
                    <div className="cart">
                        ...
                        <div className="cart__bottom">
                            <div className="cart__bottom-details">
                                ...
                                <span> Сумма заказа: <b>{`${currency === '$' ? currency: ''}${calcPrice(totalPrice, currency)}${currency !== '$' ? currency: ''}`}</b> </span>
                            </div>
