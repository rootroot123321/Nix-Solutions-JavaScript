...
const CartItem = ({id, name, type, size, totalPrice, totalCount, onPlus, onMinus, onRemove}: CartItemProps) => {
    ...
    return (
        <div className="cart__item">
            ...
            <div className="cart__item-price">
                <b>{`${currency === '$' ? currency: ''}${calcPrice(totalPrice, currency)}${currency !== '$' ? currency: ''}`}</b>
            </div>
